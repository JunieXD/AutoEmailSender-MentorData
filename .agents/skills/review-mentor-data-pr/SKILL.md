...
Use the repository's `mentor-data review` CLI as the source of truth. Read `mentor-data review --help` and the relevant subcommand help instead of reconstructing commands or decision JSON manually.
